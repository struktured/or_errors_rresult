...
(* OASIS_START *)
(* DO NOT EDIT (digest: 97feda142413ae93b329c62f041bb56f) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "Ocaml Monad, Error, Result, And Or_error Signatures backed by rresult";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Rresult_result"; "Rresult_or_error"];
                      lib_pack = true;
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "6\234W\167\198\247\015M\210fm\148s\162\"\150";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
